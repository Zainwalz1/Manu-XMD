...
SESSION_ID: process.env.SESSION_ID === undefined ? 'Manu-MD&f3tcGmQV' : process.env.SESSION_ID, // put your session id || ඔයාගෙ සෙසන් එක දාන්න...😌❤
...
SUDO: process.env.SUDO === undefined ? '263776030359' : process.env.SUDO,
